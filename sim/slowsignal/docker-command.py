...
parser = argparse.ArgumentParser(
    description="A simple interface to docker to build and run a TM slow signal simulation\n"
    "with docker containers.",
    formatter_class=argparse.ArgumentDefaultsHelpFormatter,
)

parser.add_argument("-b", dest="build", action="store_true", help="build docker image")


parser.add_argument(
    "-p", dest="print_args", action="store_true", help="print input arguments"
)
...
parser.add_argument(
    "-i", "--ip", type=str, default="172.18.0.", help="network ip for the tm modules"
)
