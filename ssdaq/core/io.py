...
class RawObjectWriterV1:
    ...
    def __init__(self,filename: str, header_ext:bytes =None, marker_ext:str='',compressor=None, bunchsize:int=1000000):
        """Summary
        ...
        self._write(RawObjectWriterV1._file_header.pack("SOF".encode(),
                                                        marker_ext.encode(),
                                                        self.version,
                                                        self.time_stamp,
                                                        compressor_id,
    ...
    def flush(self):
        ...
        bunch_crc = 0
        bunch_index_trailer = RawObjectWriterV1._bunch_trailer_header.pack(self._fp-self._last_bunch_fp,
...
class RawObjectReaderV1:
    ...
    def __init__(self, file):
        ...
        marker,extmarker,self._version,self._timestamp,self._compressed,self._lenheadext = fileheader_def.unpack(fileheader)
        if marker[:3].decode() != "SOF":
            raise TypeError("This file appears not to be a stream object file (SOF)")
        if self._version != RawObjectReaderV1._protocol_v:
            raise TypeError("This file is written with protocol V{}"
                            " while this class reads protocol V{}".format(self._version,
