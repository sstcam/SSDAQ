...
class NominalTriggerDataEncode:
    NominalTriggerData = namedtuple('NominalTriggerData','TACK trigg uc_ev uc_pps uc_clock type')
    ...
    def pack(tack:int,
        ...
        raw_packet.extend(NominalTriggerDataEncode.tail_form.pack(uc_ev,uc_pps,uc_clock,ttype,0))
        return raw_packet
    ...
    def unpack(raw_packet:bytearray):
         ...
         return NominalTriggerDataEncode.NominalTriggerData(*[tack,tbits]+list(tail[:-1]))