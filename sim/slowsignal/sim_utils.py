...
def pretty_cam_print(data_dict, size=4, type="s", tm_numbers=False):
    ...
    print(ftbs)
    if tm_numbers:
        print(tbs % (tuple([enum_tm[i] for i in range(0, 4)])))
    print(tbs % (tuple([data_dict[i] for i in range(0, 4)])))
    print(ftbs)
    print(fms)
    if tm_numbers:
        print(ms % (tuple([enum_tm[i] for i in range(4, 10)])))
    print(ms % (tuple([data_dict[i] for i in range(4, 10)])))
    print(fms)
    print(fms)
    if tm_numbers:
        print(ms % (tuple([enum_tm[i] for i in range(10, 16)])))
    print(ms % (tuple([data_dict[i] for i in range(10, 16)])))
    print(fms)
    print(fms)
    if tm_numbers:
        print(ms % (tuple([enum_tm[i] for i in range(16, 22)])))
    print(ms % (tuple([data_dict[i] for i in range(16, 22)])))
    print(fms)
    print(fms)
    if tm_numbers:
        print(ms % (tuple([enum_tm[i] for i in range(22, 28)])))
    print(ms % (tuple([data_dict[i] for i in range(22, 28)])))
    print(fms)
    print(ftbs)
    if tm_numbers:
        print(tbs % (tuple([enum_tm[i] for i in range(28, 32)])))
